...
describe('check for k-array-trees', () => {

    test('check the Fuzz Buzz resualt', () => {
        ...
        expect(fizzBuzzTree(kTree).breadth()).toEqual(['FizzBuzz', 'Fizz', 'Fizz', 'Buzz', 'Fizz', 'Buzz', 'FizzBuzz', 'Buzz', '22', '62', 'Buzz'])
    })
})